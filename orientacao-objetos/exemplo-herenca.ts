class Funcionario {
    ...
    pagarImposto(taxa: number = 7.5){ //se a taxa não for informada o default é 7.5%
...
class Executivo extends Funcionario{
    ...
    pagarImposto(taxa:number = 27.5){
        ...
        super.pagarImposto(taxa); //utilizou o metódo da superclasse Funcionário e alterou o parametro taxa
    }
}
